...
export const MOCK_VIDEOS: CourseVideo[] = [
  { number: 1,  title: 'Installing VS Code & How Websites Work',  duration: 1740, chunkCount: 87,  videoUrl: '/api/videos/1/stream'  },
  { number: 2,  title: 'Your First HTML Website',                 duration: 1620, chunkCount: 82,  videoUrl: '/api/videos/2/stream'  },
  { number: 3,  title: 'Basic Structure of an HTML Website',      duration: 600,  chunkCount: 31,  videoUrl: '/api/videos/3/stream'  },
  { number: 4,  title: 'Heading, Paragraphs and Links',           duration: 900,  chunkCount: 46,  videoUrl: '/api/videos/4/stream'  },
  { number: 5,  title: 'Image, Lists, and Tables in HTML',        duration: 1080, chunkCount: 54,  videoUrl: '/api/videos/5/stream'  },
  { number: 6,  title: 'SEO and Core Web Vitals in HTML',         duration: 720,  chunkCount: 38,  videoUrl: '/api/videos/6/stream'  },
  { number: 7,  title: 'Forms and Input Tags in HTML',            duration: 480,  chunkCount: 24,  videoUrl: '/api/videos/7/stream'  },
  { number: 8,  title: 'Inline & Block Elements in HTML',         duration: 540,  chunkCount: 29,  videoUrl: '/api/videos/8/stream'  },
  { number: 9,  title: 'Id & Classes in HTML',                    duration: 660,  chunkCount: 35,  videoUrl: '/api/videos/9/stream'  },
  { number: 10, title: 'Video, Audio & Media in HTML',            duration: 720,  chunkCount: 37,  videoUrl: '/api/videos/10/stream' },
  { number: 11, title: 'Semantic Tags in HTML',                   duration: 480,  chunkCount: 25,  videoUrl: '/api/videos/11/stream' },
  { number: 12, title: 'Exercise 1 - Pure HTML Media Player',     duration: 300,  chunkCount: 15,  videoUrl: '/api/videos/12/stream' },
  { number: 13, title: 'Entities, Code Tag and More on HTML',     duration: 540,  chunkCount: 28,  videoUrl: '/api/videos/13/stream' },
  { number: 14, title: 'Introduction to CSS',                     duration: 480,  chunkCount: 24,  videoUrl: '/api/videos/14/stream' },
  { number: 15, title: 'Inline, Internal & External CSS',         duration: 600,  chunkCount: 32,  videoUrl: '/api/videos/15/stream' },
  { number: 16, title: 'Exercise 1 - Solution & Shoutouts',       duration: 360,  chunkCount: 18,  videoUrl: '/api/videos/16/stream' },
  { number: 17, title: 'CSS Selectors MasterClass',               duration: 540,  chunkCount: 29,  videoUrl: '/api/videos/17/stream' },
  { number: 18, title: 'CSS Box Model - Margin, Padding & Borders', duration: 900, chunkCount: 47, videoUrl: '/api/videos/18/stream' },
  { number: 19, title: 'CSS Fonts, Text & Color Properties',      duration: 2400, chunkCount: 120, videoUrl: '/api/videos/19/stream' },
  { number: 20, title: 'Exercise 2 - CSS Challenge',              duration: 360,  chunkCount: 18,  videoUrl: '/api/videos/20/stream' },
  { number: 21, title: 'Sample Video',                            duration: 60,   chunkCount: 3,   videoUrl: '/api/videos/21/stream' },
];
...
I recommend starting at around **4:42** into Video #18 where the instructor begins the live coding demonstration.`,
    sources: [
      { number: 18, title: 'CSS Box Model - Margin, Padding & Borders', start: 249, end: 314, text: 'Every HTML element can be considered as a rectangular box. This is the fundamental concept behind the box model.', similarity: 0.94, videoUrl: '/api/videos/18/stream' },
      { number: 18, title: 'CSS Box Model - Margin, Padding & Borders', start: 442, end: 520, text: 'I am doing it in box1 — now I will give box1 class to this element and apply the CSS properties.', similarity: 0.87, videoUrl: '/api/videos/18/stream' },
      { number: 14, title: 'Introduction to CSS',                        start: 406, end: 450, text: 'This thing will be applied there — CSS rules cascade down and affect all matching elements.', similarity: 0.72, videoUrl: '/api/videos/14/stream' },
    ],
  },
  exercise: {
...
I recommend watching Video #12 first, trying the exercise yourself, then watching Video #16 for the solution walkthrough!`,
    sources: [
      { number: 16, title: 'Exercise 1 - Solution & Shoutouts',   start: 6,   end: 60,  text: "In today's video, I will solve that exercise and tell you the correct approach.", similarity: 0.96, videoUrl: '/api/videos/16/stream' },
      { number: 12, title: 'Exercise 1 - Pure HTML Media Player', start: 0,   end: 30,  text: 'Welcome to Exercise 1. In this exercise you have to build a pure HTML media player.', similarity: 0.91, videoUrl: '/api/videos/12/stream' },
    ],
  },
  flexbox: {
...
The course covers practical flexbox examples with live coding. Start at **Video #17** and look for the layout sections.`,
    sources: [
      { number: 17, title: 'CSS Selectors MasterClass',             start: 747, end: 820, text: 'So this class will be applied in this. The selector targets all elements with this class name.', similarity: 0.82, videoUrl: '/api/videos/17/stream' },
      { number: 15, title: 'Inline, Internal & External CSS',       start: 200, end: 280, text: 'External CSS is the recommended way to style your web pages in production.', similarity: 0.71, videoUrl: '/api/videos/15/stream' },
    ],
  },
};
...
export async function mockSearchCourse(query: string): Promise<SearchResponse> {
  ...
  const results = MOCK_VIDEOS
    ...
    .map(v => ({
      ...
      videoUrl: `/api/videos/${v.number}/stream`,
    }));
